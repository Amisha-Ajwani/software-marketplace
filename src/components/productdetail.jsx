...
import bg1 from './food1.jpg';
import bg2 from './food2.jpg';
    ...
    return (
        ...
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
            <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                <img className="w-full" alt="app image" src={bg1} />
                <img className="mt-6 w-full" alt="app image" src={bg2} />
            </div>
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                <div className="border-b border-gray-200 pb-6">
                    <p className="text-sm leading-none text-gray-600">Android+Desktop</p>
                    <h1
                        className="
							lg:text-2xl
							text-xl
                ...
                <div>
                    ...
                    <p className="text-base leading-4 mt-4 text-gray-600">Supported Platforms: Android, Desktop</p>
