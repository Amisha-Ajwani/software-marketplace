          ...
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            >
             ...
             <div className=" flex space-x-3 items-center">
                        ...
                        <h1 className=" font-normal text-2xl leading-6 text-gray-800">Software MarketPlace</h1>
                    </div>
            <button
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item">
                  <Link to="/productDetail"  className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75">Product Details</Link>             
              </li>
              <li className="nav-item">
                  <Link to="/products"  className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75">Products</Link>             
              </li>
              <li className="nav-item">
                  <Link to="/faq"  className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75">FAQ</Link>             
              </li>
            </ul>
          </div>
        </div>
